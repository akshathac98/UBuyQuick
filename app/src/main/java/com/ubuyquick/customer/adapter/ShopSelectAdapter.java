            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (getAdapterPosition() != RecyclerView.NO_POSITION) {
                        Intent i = new Intent(context, DeliveryOptionsActivity.class);
                        i.putExtra("shop_id", shops.get(getAdapterPosition()).getShopId());
                        i.putExtra("shop_vendor", shops.get(getAdapterPosition()).getShopVendor());
                        i.putExtra("checkout_list", "temp_list");
